...
me = Tk()
me.geometry("354x460")
me.title("PY-CHARM CALCULATOR")
melabel = Label(me, text="CALCULATOR", bg='WHITE', font=("Times", 25, 'bold'))
...
metext = Entry(me, font=("Courier New", 16, 'bold'), textvar=textin, width=35, bd=15, bg='powder blue')
metext.pack()
...
butclear = Button(me, padx=14, pady=155,bd=4, bg='white', text="CE", command=clrbut, font=("Courier New", 16, 'bold'))
butclear.place(x=270, y=100)

butequal = Button(me, padx=111, pady=14, bd=4, bg='white', command=equlbut, text="=", font=("Courier New", 16, 'bold'))
